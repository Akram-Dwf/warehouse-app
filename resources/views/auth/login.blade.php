<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-6 text-center border-t border-gray-100 pt-4">
            <p class="text-sm text-gray-600">Belum punya akun Supplier?</p>
            <a href="{{ route('register') }}" class="text-sm font-bold text-blue-600 hover:underline">Daftar sebagai Supplier</a>
        </div>
    </form>
</x-guest-layout>