                    ...
                    <form action="{{ route('users.update', $user) }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700">
                                Peran (Role) 
                                <span class="text-xs text-red-500 italic ml-1">*Tidak dapat diubah</span>
                            </label>
                            
                            <select name="role" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-100 text-gray-500 cursor-not-allowed" disabled>
