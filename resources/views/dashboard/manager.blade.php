        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-yellow-500">
                    <div class="text-gray-500 text-sm font-medium uppercase">Transaksi Perlu Approval</div>
                    <div class="text-3xl font-bold text-gray-800 mt-2">{{ $data['pending_transactions'] }}</div>
                    <a href="{{ route('transactions.index') }}" class="text-xs text-blue-600 hover:underline mt-1 block">Proses Sekarang &rarr;</a>
                </div>
            </div>
